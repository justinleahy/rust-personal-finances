...
INSERT INTO transactions (id, account_id, transaction_date, transaction_type, category, transaction_integer, transaction_decimal, transaction_exponent, comment)
    VALUES ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '2023-10-06', 'transfer', 'transfer', 8, 9966, 2, 'Webull Transfer');
INSERT INTO transactions (id, account_id, transaction_date, transaction_type, category, transaction_integer, transaction_decimal, transaction_exponent, comment)
    VALUES ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', '2023-10-07', 'expense', 'expense', 1, 0043, 2, 'Tops');